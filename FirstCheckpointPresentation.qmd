...
## Down and distance are major tells of what a team will do
...
<ul>
        <li class="fragment">**Accuracy**: 72.1%</li>
        <li class="fragment">**AUC**: 0.8085</li>
  </ul>

. . . 

* These features reflect the actual decision-making context coaches face in real time.  
By focusing on pre-snap variables, the model helps identify patterns in playcalling strategy, making it well-suited for evaluating tendencies and building opponent scouting tools.
